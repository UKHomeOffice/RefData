...
-- Table comment
COMMENT ON TABLE address IS '{"label": "Address list", "description": "A list of addresses for locations.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN address.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
