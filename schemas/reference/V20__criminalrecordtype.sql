...
-- Table comment
COMMENT ON TABLE criminalrecordtype IS '{"label": "Criminal record", "description": "Criminal record type and description.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN criminalrecordtype.id IS '{"label": "Identifier", "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
COMMENT ON COLUMN criminalrecordtype.recordname IS '{"label": "Record name", "businesskey": true, "description": "Record category", "summaryview": "true"}';
