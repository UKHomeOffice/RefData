...
-- Table comment
COMMENT ON TABLE damagemethod IS '{"label": "Damage methods", "description": "Methods of damage used to gain entry.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN damagemethod.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "summaryview": "false"}';
