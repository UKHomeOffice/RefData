...
-- Table comment
COMMENT ON TABLE workarea IS '{"label": "Working areas", "description": "A list of working areas.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN workarea.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
