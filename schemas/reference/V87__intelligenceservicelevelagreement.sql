...
-- Table comment
COMMENT ON TABLE intelligenceservicelevelagreement IS '{"label": "Service Level Agreement", "description": "Descriptions of activities related to SLAs.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN intelligenceservicelevelagreement.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "summaryview": "false"}';
