...
-- Table comment
COMMENT ON TABLE command IS '{"label": "Command list", "description": "A list of commands and their associated codes.", "owner": "cop@homeoffice.gov.uk", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN command.id IS '{"label": "Identifier", "description": "Unique identifying column.", "summaryview": "false"}';
COMMENT ON COLUMN command.name IS '{"label": "Name", "description": "The name of the command.", "businesskey": "true", "summaryview": "true"}';
