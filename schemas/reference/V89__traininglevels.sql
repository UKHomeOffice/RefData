CREATE TABLE traininglevels (
 ...
 -- Table comment
COMMENT ON TABLE traininglevels IS '{"label": "Training levels", "description": "Training levels for different courses.", owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN traininglevels.id IS '{"label": "Identifier", "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
