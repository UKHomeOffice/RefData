...
-- Table comment
COMMENT ON TABLE nationality IS '{"label": "Nationalities", "description": "A list of global nationalities.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN nationality.id IS '{"label": "Identifier", "description": "Database unique identity record.", "businesskey": true, "summaryview": "false"}';
