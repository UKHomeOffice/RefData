...
-- Table comment
COMMENT ON TABLE ferries IS '{"label": "Ferries", "description": "A list of ferries that arrive at UK ports.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN ferries.id IS '{"label": "Identifier", "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
