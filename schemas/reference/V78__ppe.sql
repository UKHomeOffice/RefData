...
-- Table comment
COMMENT ON TABLE ppe IS '{"label": "PPE", "description": "Different types of PPE for saftey and use of force.", "owner": "cop@homeoffice.gov.uk", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN ppe.id IS '{"label": "Identifier", "description": "Unique identifying column.", "summaryview": "false"}';
COMMENT ON COLUMN ppe.type IS '{"label": "Type", "description": "Description of PPE.", "businesskey": "true", "summaryview": "true"}';
