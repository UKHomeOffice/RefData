...
-- Table comment
COMMENT ON TABLE trailertypes IS '{"label": "Trailer types", "description": "A list of different types of trailer.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN trailertypes.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "summaryview": "false"}';
