CREATE TABLE pstmethods (
 ...
 -- Table comment
COMMENT ON TABLE pstmethods IS '{"label": "Behaviour Signs", "description": "Behaviours Warning and Danger Signs", "schemalastupdated": "06/03/2019", "dataversion": 1}';
-- Column comments
...
COMMENT ON COLUMN pstmethods.nerve IS '{"label": "Nerve", "description": "Is this a nerve methods", "summaryview": "true"}';
