...
COMMENT ON COLUMN port.noneoperational IS '{"label": "None Operational", "description": "Is this a non-operational location", "summaryview" : "false"}';
