...
-- Table comment
COMMENT ON TABLE targetcat IS '{"label": "Targeting types", "description": "A list of targeting types.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN targetcat.id IS '{"label": "Identifier", "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
COMMENT ON COLUMN targetcat.type IS '{"label": "Target type", "businesskey": true, "description": "The type of target.", "summaryview": "true"}';
