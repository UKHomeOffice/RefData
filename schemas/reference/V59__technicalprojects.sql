...
-- Table comment
COMMENT ON TABLE technicalprojects IS '{"label": "Technical Projects", "description": "A list of technical projects and their associated teams.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN technicalprojects.id IS '{"label": "Identifier", "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
