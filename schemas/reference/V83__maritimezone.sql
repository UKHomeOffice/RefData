...
-- Table comment
COMMENT ON TABLE maritimezone IS '{"label": "Maritime Zone", "description": "Areas of UK territorial waters.", "owner": "cop@homeoffice.gov.uk", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
...
COMMENT ON COLUMN maritimezone.name IS '{"label": "Name", "description": "The non-abbreviated name of the zone.", "businesskey": "true", "summaryview": "true"}';
