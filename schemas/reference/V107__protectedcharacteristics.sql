...
-- Table comment
COMMENT ON TABLE protectedcharacteristics IS '{"label": "Protected characteristics", "description": "Characteristics which are protected from discrimination by law", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN protectedcharacteristics.id IS '{"label": "Identifier", "businesskey": true, "description": "Database unique identity record.", "summaryview": "false"}';
