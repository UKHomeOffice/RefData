...
-- Table comment
COMMENT ON TABLE eventtype IS '{"label": "Event types", "description": "A list containing different event types.", "owner": "cop@homeoffice.gov.uk", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN eventtype.id IS '{"label": "Identifier", "description": "Unique identifying column.", "summaryview": "false"}';
COMMENT ON COLUMN eventtype.type IS '{"label": "Event types", "businesskey": "true", "description": "Descriptions of the different event types.", "businesskey": "true", "summaryview": "true"}';
