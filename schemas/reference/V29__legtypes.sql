...
-- Table comment
COMMENT ON TABLE legtypes IS '{"label": "Mode of leg journey", "description": "A description of the journey leg type.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN legtypes.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
