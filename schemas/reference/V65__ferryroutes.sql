...
-- Table comment
COMMENT ON TABLE ferryroutes IS '{"label": "Ferry crossing routes", "description": "A list of ferry routes to the UK.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN ferryroutes.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "summaryview": "false"}';
