...
-- Table comment
COMMENT ON TABLE reasons IS '{"label": "Reasons behind seizure", "description": "Summary list of reasons for a seizure.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN reasons.id IS '{"label": "Identifier", "description": "Unique identifying column.", "businesskey": true, "summaryview": "false"}';
