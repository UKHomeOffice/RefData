...
-- Table comment
COMMENT ON TABLE profileindicatorletters IS '{"label": "Profile indicator letters", "description": "A list of different types of profile indicator letter codes.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN profileindicatorletters.id IS '{"label": "Letter code", "businesskey": true, "description": "Profile indicator lettter code - Unique identifying column.", "summaryview": "true"}';
