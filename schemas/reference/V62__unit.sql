...
-- Table comment
COMMENT ON TABLE unit IS '{"label": "Units of Measure", "description": "A list of units of measure - level 1", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN unit.id IS '{"label": "Identifier", "description": "Database unique identity record.", "businesskey": true, "summaryview": "false"}';
COMMENT ON COLUMN unit.unit IS '{"label": "Unit", "businesskey": true, "description": "Type of unit", "summaryview": "false"}';
