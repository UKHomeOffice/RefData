...
-- Table comment
COMMENT ON TABLE operations IS '{"label": "List of operations names", "description": "List of current operations Border Force is involved with", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
