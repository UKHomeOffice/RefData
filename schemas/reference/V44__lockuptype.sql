...
-- Table comment
COMMENT ON TABLE lockuptype IS '{"label": "Types of lockup", "description": "Types of lockup and associated codes.", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN lockuptype.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "summaryview": "false"}';
