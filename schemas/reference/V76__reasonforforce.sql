...
-- Table comment
COMMENT ON TABLE reasonforforce IS '{"label": "Reason for force", "description": "What prompted the requirement of force.", "owner": "xyx@test.com", "schemalastupdated": "06/03/2019", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN reasonforforce.id IS '{"label": "Identifier", "businesskey": true, "description": "Unique identifying column.", "summaryview": "false"}';
