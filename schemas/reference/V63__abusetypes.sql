...
-- Table comment
COMMENT ON TABLE abusetypes IS '{"label": "Abuse type", "description": "A list of types of abuse", "owner": "xyx@test.com", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN abusetypes.id IS '{"label": "Identifier", "businesskey": true, "description": "Database unique identity record.", "summaryview": "false"}';
