...
-- Table comment
COMMENT ON TABLE modeoftransport IS '{"label": "Mode of transportation", "description": "A list detailing modes of transport.", "owner": "cop@homeoffice.gov.uk", "schemalastupdated": "03/12/2020", "dataversion": 1}';
-- Column comments
COMMENT ON COLUMN modeoftransport.id IS '{"label": "Identifier", "description": "Unique identifying column.", "summaryview": "false"}';
COMMENT ON COLUMN modeoftransport.type IS '{"label": "Type", "businesskey": true, "description": "Types of transport.", "businesskey": true, "summaryview": "true"}';
